# Generated by Django 5.1.5 on 2025-02-10 22:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descripcion', models.TextField(blank=True, null=True)),
                ('id_espacio', models.CharField(blank=True, max_length=10, null=True, unique=True)),
                ('status', models.CharField(choices=[('available', 'Disponible'), ('reserved', 'Reservado'), ('inactive', 'Inactivo')], default='available', max_length=10)),
                ('color', models.CharField(choices=[('default', 'Por defecto'), ('yellow', 'Amarillo'), ('red-mark', 'Marca roja'), ('red-dot', 'Punto rojo'), ('orange', 'Naranja')], default='default', max_length=10)),
